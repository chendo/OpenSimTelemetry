...
impl DemoAdapter {
    ...
    fn generate_frame(&mut self) -> TelemetryFrame {
        ...
        let vehicle = Some(VehicleData {
            ...
            track_surface: Some(TrackLocation::OnTrack),
        ...
        let timing = Some(TimingData {
            ...
            lap_distance_pct: Some(LapFraction::new(lap_dist_pct)),
        ...
        let competitors = Some(vec![
            CompetitorData {
                ...
                lap_distance_pct: Some(LapFraction::new(comp_a_pct)),
                position: Some(1),
            ...
            CompetitorData {
                ...
                lap_distance_pct: Some(LapFraction::new(comp_b_pct)),
                position: Some(2),
                class_position: Some(2),
                on_pit_road: Some(false),
                track_surface: Some(TrackLocation::OnTrack),
